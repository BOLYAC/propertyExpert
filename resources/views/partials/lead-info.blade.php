                ...
                <table class="table m-0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="https://wa.me/{{$client->client->client_number ?? $client->lead_phone_2 ?? '' }}"
                               target="_blank"
                    ...
                    <tr>
                        ...
                        <td>
                            @php
                                ...
                                break;
                                case 16:
                                echo '<span class="badge badge-light-warning">' . __('Unassigned') . '</span>';
                                break;
                                case 17:
                                ...
                                break;
                                case 21:
                                echo '<span class="badge badge-light-primary">' . __('Agent') . '</span>';
                                break;
                                case 22:
                                echo '<span class="badge badge-light-primary">' . __('Transferred') . '</span>';
                                break;
                                case 23:
                                echo '<span class="badge badge-light-warning">' . __('No Answering') . '</span>';
                                break;
                                }
                            @endphp
                        </td>
